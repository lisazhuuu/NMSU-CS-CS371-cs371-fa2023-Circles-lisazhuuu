...
/**
 * Implements a class that is consisted of test cases for Circle2
 * The test cases should fully test the functions in Circle and Circle2
 */
public class Circle2Test {
   // Data you need for each test case
   private Circle2 circle2;
   private Circle2 otherCircle;
   ...
   /**
    * Found error in first line of class of Circle2.java
    * @Test
    * This test case tests the moveBy() method in Circle 
   ...
   /**
    * @Test
    * This test case tests the intersects() method in Circle2
   ...
   {
      boolean b;
      System.out.println("Running test intersectsTP.");
      otherCircle = new Circle2(4, 5, 4);
      b = circle2.intersects(otherCircle);
      assertTrue(b==true);
   }

   /**
    * Found error in intersects(Circle other) method of Circle2.java
    * @Test
    * This test case tests the intersects() method in Circle2
   ...
   {
      boolean b;
      System.out.println("Running test intersectsTN.");
      otherCircle = new Circle2(-1.9, -0.9, 7);
      b = circle2.intersects(otherCircle);
      assertTrue(b==true);
   }
   ...
   public void intersectsF()
   {
      ...
      otherCircle = new Circle2(10, 10, 4);
      b = circle2.intersects(otherCircle);
      assertTrue(b==false);
   }
}
